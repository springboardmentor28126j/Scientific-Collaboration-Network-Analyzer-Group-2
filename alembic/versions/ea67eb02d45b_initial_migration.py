...
def upgrade() -> None:
    ...
    sa.Column('action', sa.Enum('CREATED', 'UPDATED', 'PDF_UPDATED', 'AUTHOR_ADDED', 'AUTHOR_REMOVED', 'SUBMITTED', 'RESUBMITTED', 'REVIEWER_ASSIGNED', 'REVIEWER_UNASSIGNED', 'REVIEW_SUBMITTED', 'REVISION_REQUESTED', 'ACCEPTED', 'REJECTED', 'PUBLISHED', 'ARCHIVED', name='publication_history_action_enum'), nullable=False),
