...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("requester_id", sa.Integer(), sa.ForeignKey("researchers.id"), nullable=False),
        sa.Column("addressee_id", sa.Integer(), sa.ForeignKey("researchers.id"), nullable=False),
        sa.Column(
            "status",
            sa.Enum("PENDING", "ACCEPTED", "REJECTED", "CANCELLED", name="collaborationrequeststatus"),
            nullable=False,
    ...
    op.create_index("ix_collaboration_requests_addressee_id", "collaboration_requests", ["addressee_id"])
    op.create_index("ix_collaboration_requests_status", "collaboration_requests", ["status"])

    op.create_table(
        "collaborations",
        sa.Column("id", sa.Integer(), primary_key=True, index=True),
        sa.Column("researcher1_id", sa.Integer(), sa.ForeignKey("researchers.id"), nullable=False),
        sa.Column("researcher2_id", sa.Integer(), sa.ForeignKey("researchers.id"), nullable=False),
    ...
    op.create_index("ix_collaborations_researcher1_id", "collaborations", ["researcher1_id"])
    op.create_index("ix_collaborations_researcher2_id", "collaborations", ["researcher2_id"])
    ...
    op.create_index("ix_collaboration_publications_collaboration_id", "collaboration_publications", ["collaboration_id"])
    op.create_index("ix_collaboration_publications_publication_id", "collaboration_publications", ["publication_id"])


def downgrade() -> None:
    op.drop_index("ix_collaboration_publications_publication_id", table_name="collaboration_publications")
    op.drop_index("ix_collaboration_publications_collaboration_id", table_name="collaboration_publications")
    ...
    op.drop_index("ix_collaboration_requests_addressee_id", table_name="collaboration_requests")
    op.drop_index("ix_collaboration_requests_requester_id", table_name="collaboration_requests")
